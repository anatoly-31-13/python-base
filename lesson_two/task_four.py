...
job = ' '
new_workers = job.join(workers)
print(new_workers.title())

print('Привет', new_workers[20:26].title())
print('Привет', new_workers[44:51].title())
print('Привет', new_workers[74:82].title())